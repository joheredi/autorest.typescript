import { Languages, Language as ModelerLanguage, Operation } from "@azure-tools/codemodel";
...
export declare type Language = ModelerLanguage & {
    paging?: PaginationExtension;
};
export declare function getLanguageMetadata(languages: Languages): Language;
//# sourceMappingURL=languageHelpers.d.ts.map