...
function generatePackageJson(clientDetails, packageDetails, project) {
    ...
    project.createSourceFile("package.json", JSON.stringify(packageJsonContents), {
        overwrite: true
    });
}
exports.generatePackageJson = generatePackageJson;
//# sourceMappingURL=packageFileGenerator.js.map