import { HttpMethod, Parameter, VirtualParameter } from "@azure-tools/codemodel";
...
export declare type OperationResponseMapper = Mapper | string;
/**
...
export declare type OperationSpecResponses = {
...
//# sourceMappingURL=operationDetails.d.ts.map