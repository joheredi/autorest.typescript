...
const responseExistingKeyOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseExistingKeyHeaders },
...
const responseProtectedKeyOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseProtectedKeyHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  serializer
...
const responseIntegerOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseIntegerHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
...
const responseLongOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseLongHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseFloatOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseFloatHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseDoubleOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseDoubleHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseBoolOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseBoolHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseStringOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseStringHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseDateOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseDateHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseDatetimeOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseDatetimeHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseDatetimeRfc1123OperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseDatetimeRfc1123Headers },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseDurationOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseDurationHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseByteOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseByteHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
...
const responseEnumOperationSpec: coreHttp.OperationSpec = {
  ...
  httpMethod: "POST",
  responses: {
    200: { headersMapper: Mappers.HeaderResponseEnumHeaders },
    default: { bodyMapper: Mappers.ErrorModel }
  },
  urlParameters: [Parameters.$host],
  headerParameters: [Parameters.scenario],
