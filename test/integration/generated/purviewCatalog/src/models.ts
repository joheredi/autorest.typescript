...
export interface JsonAtlasEntityBase {
  ...
  relationshipAttributes?: JsonAtlasEntityRelationshipAttributes;
  ...
  sourceDetails?: JsonAtlasEntitySourceDetails;
  /** The dictionary of contacts for terms. Key could be Expert or Owner. */
  contacts?: JsonAtlasEntityContacts;
}
...
export interface JsonAtlasClassificationBase {
  ...
  source?: string;
  /** more detail on source information */
  sourceDetails?: JsonAtlasClassificationSourceDetails;
}
...
export interface JsonAtlasStruct {
  ...
  attributes?: JsonAtlasStructAttributes;
...
export interface JsonAtlasEntityExtInfo {
  ...
  referredEntities?: JsonAtlasEntityExtInfoReferredEntities;
}

export interface JsonEntityMutationResponse {
  /** A map of GUID assignments with entities. */
  guidAssignments?: JsonEntityMutationResponseGuidAssignments;
  /** The entity headers of mutated entities. */
  mutatedEntities?: JsonEntityMutationResponseMutatedEntities;
...
export interface JsonAtlasEntityHeaders {
  ...
  guidHeaderMap?: JsonAtlasEntityHeadersGuidHeaderMap;
}
...
export interface JsonAtlasGlossaryTermBase {
  ...
  contacts?: JsonAtlasGlossaryTermContacts;
  /**
   ...
   */
  attributes?: JsonTermCustomAttributes;
...
export interface JsonAtlasObjectId {
  ...
  uniqueAttributes?: JsonAtlasObjectIdUniqueAttributes;
}
...
export interface JsonAtlasGlossaryExtInfoBase {
  ...
  categoryInfo?: JsonAtlasGlossaryExtInfoCategoryInfo;
  /** The glossary term information. */
  termInfo?: JsonAtlasGlossaryExtInfoTermInfo;
}
...
export interface JsonAtlasLineageInfo {
  ...
  /** The GUID entity map. */
  guidEntityMap?: JsonAtlasLineageInfoGuidEntityMap;
  /** The entity count in specific direction. */
  widthCounts?: JsonAtlasLineageInfoWidthCounts;
...
export interface JsonAtlasRelationshipWithExtInfo {
  ...
  referredEntities?: JsonAtlasRelationshipWithExtInfoReferredEntities;
...
export interface JsonAtlasAttributeDef {
  ...
  options?: JsonAtlasAttributeDefOptions;
  /** The name of the type. */
  typeName?: string;
...
export interface JsonAtlasConstraintDef {
  ...
  params?: JsonAtlasConstraintDefParams;
...
export interface JsonAtlasBaseTypeDef {
  ...
  options?: JsonAtlasBaseTypeDefOptions;
  /** The service type. */
  serviceType?: string;
...
export type JsonRelation =
  ...
  | "VALID_VALUES"
  | "VALID_VALUES_FOR";
export type JsonAtlasClassificationSourceDetails = { [key: string]: any };
export type JsonAtlasStructAttributes = { [key: string]: any };
export type JsonAtlasEntityRelationshipAttributes = { [key: string]: any };
export type JsonAtlasEntitySourceDetails = { [key: string]: any };
export type JsonAtlasEntityContacts = { [key: string]: JsonContactBasic[] };
export type JsonAtlasEntityExtInfoReferredEntities = {
  [key: string]: JsonAtlasEntity;
};
export type JsonEntityMutationResponseGuidAssignments = {
  [key: string]: string;
};
export type JsonEntityMutationResponseMutatedEntities = {
  [key: string]: JsonAtlasEntityHeader[];
};
export type JsonAtlasEntityHeadersGuidHeaderMap = {
  [key: string]: JsonAtlasEntityHeader;
};
export type DictionaryOfpathsCic80AAtlasV2GlossaryCategoryCategoryguidRelatedGetResponses200ContentApplicationJsonSchemaAdditionalproperties = {
  [key: string]: JsonAtlasRelatedCategoryHeader[];
};
export type JsonAtlasGlossaryTermContacts = {
  [key: string]: JsonContactBasic[];
};
export type JsonTermCustomAttributesExtraProperties = { [key: string]: any };
export type JsonTermCustomAttributes = {
  [key: string]: JsonTermCustomAttributesExtraProperties;
};
export type JsonAtlasObjectIdUniqueAttributes = { [key: string]: any };
export type DictionaryOfpathsV84KwqAtlasV2GlossaryTermsTermguidRelatedGetResponses200ContentApplicationJsonSchemaAdditionalproperties = {
  [key: string]: JsonAtlasRelatedTermHeader[];
};
export type JsonAtlasGlossaryExtInfoCategoryInfo = {
  [key: string]: JsonAtlasGlossaryCategory;
};
export type JsonAtlasGlossaryExtInfoTermInfo = {
  [key: string]: JsonAtlasGlossaryTerm;
};
export type DictionaryOfString = { [key: string]: string };
export type JsonAtlasLineageInfoGuidEntityMap = {
  [key: string]: JsonAtlasEntityHeader;
};
export type JsonAtlasLineageInfoExtraProperties = { [key: string]: any };
export type JsonAtlasLineageInfoWidthCounts = {
  [key: string]: JsonAtlasLineageInfoExtraProperties;
};
export type JsonAtlasRelationshipWithExtInfoReferredEntities = {
  [key: string]: JsonAtlasEntityHeader;
};
export type JsonAtlasConstraintDefParams = { [key: string]: any };
export type JsonAtlasAttributeDefOptions = { [key: string]: string };
export type JsonAtlasBaseTypeDefOptions = { [key: string]: string };
export type JsonTypeStatisticsDictionary = {
  [key: string]: JsonTypeStatisticsExtraProperties;
};
export type JsonSearchFilterParams = { [key: string]: string[] };
