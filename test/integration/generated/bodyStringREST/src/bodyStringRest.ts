...
export interface StringPutNull {
...
export interface StringPutEmpty {
...
export interface StringPutMbcs {
...
export interface StringPutWhitespace {
...
export interface StringPutBase64UrlEncoded {
...
export interface EnumPutNotExpandable {
...
export interface EnumPutReferenced {
  /** Get enum value 'red color' from enumeration of 'red color', 'green-color', 'blue_color'. */
  get(
...
export interface EnumPutReferencedConstant {
...
export interface Routes {
  ...
  (path: "/string/base64UrlEncoding"): StringPutBase64UrlEncoded;
