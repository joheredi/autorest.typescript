...
export interface XmlPropertyDeserializeMetadata {
  ...
  /** Date encoding format */
  dateEncoding?: "rfc3339" | "rfc7231" | "unixTimestamp";
  /** Primitive subtype for explicit type conversion (avoids parser auto-coercion) */
...
function deserializePrimitiveValue(
  ...
  // Explicit type conversion based on primitiveSubtype (since auto-coercion is disabled)
...
function deserializeArrayProperty(
  ...
  const { xmlOptions, deserializer, type, dateEncoding, primitiveSubtype } =
    metadata;
