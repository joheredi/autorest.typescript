...
export class StorageClient {
    ...
    private _clientParams: {endpointParam: string,accountName: string,options: StorageClientOptionalParams};
    ...
    constructor(endpointParam: string, accountName: string, options: StorageClientOptionalParams = {}) {
        ...
        this._client = createStorage(endpointParam,accountName,{...options, userAgentOptions: { userAgentPrefix }});
    ...
    getBlobClient(blobName: string, options: BlobClientOptionalParams = {}): BlobClient {
        return new BlobClient(
              this._clientParams.endpointParam,this._clientParams.accountName,
              blobName,
