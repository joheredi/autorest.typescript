...
import { registerSchema, getSchemaIdByContent, getSchemaByVersion, listSchemaVersions, getSchemaById, listSchemaGroups } from "../../api/schemaOperations/operations.js";
...
function _getSchemaOperations(context: SchemaRegistryContext) {
    return {
            registerSchema: (groupName: string,name: string,content: Uint8Array,contentType: SchemaContentTypeValues,options?: SchemaOperationsRegisterSchemaOptionalParams) => registerSchema(context,groupName,name,content,contentType,options),getSchemaIdByContent: (groupName: string,name: string,contentType: SchemaContentTypeValues,schemaContent: Uint8Array,options?: SchemaOperationsGetSchemaIdByContentOptionalParams) => getSchemaIdByContent(context,groupName,name,contentType,schemaContent,options),getSchemaByVersion: (groupName: string,name: string,schemaVersion: number,options?: SchemaOperationsGetSchemaByVersionOptionalParams) => getSchemaByVersion(context,groupName,name,schemaVersion,options),listSchemaVersions: (groupName: string,name: string,options?: SchemaOperationsListSchemaVersionsOptionalParams) => listSchemaVersions(context,groupName,name,options),getSchemaById: (id: string,options?: SchemaOperationsGetSchemaByIdOptionalParams) => getSchemaById(context,id,options),listSchemaGroups: (options?: SchemaOperationsListSchemaGroupsOptionalParams) => listSchemaGroups(context,options)
          }
}

export function _getSchemaOperationsOperations(context: SchemaRegistryContext): SchemaOperationsOperations {
    return {
