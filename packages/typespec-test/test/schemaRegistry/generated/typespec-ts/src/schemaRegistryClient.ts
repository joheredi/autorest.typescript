import { createSchemaRegistry, SchemaRegistryContext, SchemaRegistryClientOptionalParams } from "./api/index.js";
import { SchemaOperationsOperations, _getSchemaOperationsOperations } from "./classic/schemaOperations/index.js";
...
export class SchemaRegistryClient {
    ...
    constructor(endpointParam: string, credential: TokenCredential, options: SchemaRegistryClientOptionalParams = {}) {
        ...
        this._client = createSchemaRegistry(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
