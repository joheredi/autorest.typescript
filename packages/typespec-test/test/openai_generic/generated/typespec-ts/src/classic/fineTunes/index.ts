...
import { FineTunesCancelOptionalParams, FineTunesListEventsOptionalParams, FineTunesRetrieveOptionalParams, FineTunesListOptionalParams, FineTunesCreateOptionalParams } from "../../api/fineTunes/options.js";
...
function _getFineTunes(context: OpenAIContext) {
    return {
            cancel: (fineTuneId: string,options?: FineTunesCancelOptionalParams) => cancel(context,fineTuneId,options),listEvents: (fineTuneId: string,options?: FineTunesListEventsOptionalParams) => listEvents(context,fineTuneId,options),retrieve: (fineTuneId: string,options?: FineTunesRetrieveOptionalParams) => retrieve(context,fineTuneId,options),list: (options?: FineTunesListOptionalParams) => list(context,options),create: (fineTune: CreateFineTuneRequest,options?: FineTunesCreateOptionalParams) => create(context,fineTune,options)
          }
}
