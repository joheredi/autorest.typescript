...
import { ModelsDeleteOptionalParams, ModelsRetrieveOptionalParams, ModelsListOptionalParams } from "../../api/models/options.js";
...
function _getModels(context: OpenAIContext) {
    return {
            delete: (model: string,options?: ModelsDeleteOptionalParams) => $delete(context,model,options),retrieve: (model: string,options?: ModelsRetrieveOptionalParams) => retrieve(context,model,options),list: (options?: ModelsListOptionalParams) => list(context,options)
          }
}
