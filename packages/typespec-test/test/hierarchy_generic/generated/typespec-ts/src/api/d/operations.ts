...
export function _op1Send(context: Client, body: A, options: DOp1OptionalParams = { requestOptions: {} }): StreamableMethod {
    return context.path("/d").post({...operationOptionsToRequestParameters(options), contentType: "application/json",
...
export async function op1(context: Client, body: A, options: DOp1OptionalParams = { requestOptions: {} }): Promise<void> {
