...
export function _op1Send(context: Client, body: BA, options: BOp1OptionalParams = { requestOptions: {} }): StreamableMethod {
    return context.path("/b").post({...operationOptionsToRequestParameters(options), contentType: "application/json",
...
export async function op1(context: Client, body: BA, options: BOp1OptionalParams = { requestOptions: {} }): Promise<void> {
