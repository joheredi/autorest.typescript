...
export function _op1Send(context: Client, body: BEA, options: BECOp1OptionalParams = { requestOptions: {} }): StreamableMethod {
    return context.path("/b/e").post({...operationOptionsToRequestParameters(options), contentType: "application/json",
...
export async function op1(context: Client, body: BEA, options: BECOp1OptionalParams = { requestOptions: {} }): Promise<void> {
