...
import { YTestOperationsTestDataverseV2OptionalParams, YTestOperationsTestDataverseOptionalParams } from "../../../api/y/testOperations/options.js";
...
function _getYTestOperations(context: FooContext) {
    return {
            testDataverseV2: (options?: YTestOperationsTestDataverseV2OptionalParams) => testDataverseV2(context,options),testDataverse: (options?: YTestOperationsTestDataverseOptionalParams) => testDataverse(context,options)
          }
}
