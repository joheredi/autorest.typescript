...
import { FooOperationsGetAvatarAsJpegOptionalParams, FooOperationsGetAvatarAsPngOptionalParams } from "../../api/fooOperations/options.js";
...
function _getFooOperations(context: WidgetManagerContext) {
    return {
            getAvatarAsJpeg: (image: Uint8Array,options?: FooOperationsGetAvatarAsJpegOptionalParams) => getAvatarAsJpeg(context,image,options),getAvatarAsPng: (image: Uint8Array,options?: FooOperationsGetAvatarAsPngOptionalParams) => getAvatarAsPng(context,image,options)
          }
}

export function _getFooOperationsOperations(context: WidgetManagerContext): FooOperationsOperations {
    return {
