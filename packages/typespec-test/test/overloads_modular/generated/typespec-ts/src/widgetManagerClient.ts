import { createWidgetManager, WidgetManagerContext, WidgetManagerClientOptionalParams } from "./api/index.js";
import { FooOperationsOperations, _getFooOperationsOperations } from "./classic/fooOperations/index.js";
...
export class WidgetManagerClient {
    ...
    constructor(endpointParam: string, credential: (KeyCredential | TokenCredential), options: WidgetManagerClientOptionalParams = {}) {
        ...
        this._client = createWidgetManager(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
