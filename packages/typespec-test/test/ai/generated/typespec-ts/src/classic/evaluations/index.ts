...
import { disableSchedule, listSchedule, createOrReplaceSchedule, getSchedule, update, list, create, get } from "../../api/evaluations/operations.js";
import { EvaluationsDisableScheduleOptionalParams, EvaluationsListScheduleOptionalParams, EvaluationsCreateOrReplaceScheduleOptionalParams, EvaluationsGetScheduleOptionalParams, EvaluationsUpdateOptionalParams, EvaluationsListOptionalParams, EvaluationsCreateOptionalParams, EvaluationsGetOptionalParams } from "../../api/evaluations/options.js";
...
function _getEvaluations(context: AIProjectContext) {
    return {
            disableSchedule: (name: string,options?: EvaluationsDisableScheduleOptionalParams) => disableSchedule(context,name,options),listSchedule: (options?: EvaluationsListScheduleOptionalParams) => listSchedule(context,options),createOrReplaceSchedule: (name: string,resource: EvaluationSchedule,options?: EvaluationsCreateOrReplaceScheduleOptionalParams) => createOrReplaceSchedule(context,name,resource,options),getSchedule: (name: string,options?: EvaluationsGetScheduleOptionalParams) => getSchedule(context,name,options),update: (id: string,resource: Evaluation,options?: EvaluationsUpdateOptionalParams) => update(context,id,resource,options),list: (options?: EvaluationsListOptionalParams) => list(context,options),create: (evaluation: Evaluation,options?: EvaluationsCreateOptionalParams) => create(context,evaluation,options),get: (id: string,options?: EvaluationsGetOptionalParams) => get(context,id,options)
          }
}
