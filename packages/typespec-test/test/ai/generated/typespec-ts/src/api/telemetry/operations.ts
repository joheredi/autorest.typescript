...
export function _getAppInsightsSend(context: Client, appInsightsResourceUrl: string, options: TelemetryGetAppInsightsOptionalParams = { requestOptions: {} }): StreamableMethod {
    const path = expandUrlTemplate("/{appInsightsResourceUrl}{?api%2Dversion}", {
...
export async function _getAppInsightsDeserialize(result: PathUncheckedResponse): Promise<GetAppInsightsResponse> {
...
export async function getAppInsights(context: Client, appInsightsResourceUrl: string, options: TelemetryGetAppInsightsOptionalParams = { requestOptions: {} }): Promise<GetAppInsightsResponse> {
