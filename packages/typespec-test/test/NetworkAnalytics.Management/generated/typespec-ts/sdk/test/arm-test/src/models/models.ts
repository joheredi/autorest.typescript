...
export type ArrayOperation = Array<Operation>;
/**
...
export type ArrayPublisherInformation = Array<PublisherInformation>;
/**
...
export type ArrayDataProductInformation = Array<DataProductInformation>;
/**
 * Data Product Information
 */
...
export type ArrayDataProductVersion = Array<DataProductVersion>;
/**
...
export type ArrayDataProductsCatalog = Array<DataProductsCatalog>;
/**
...
export type ArrayDataType = Array<DataType>;
/**
...
export type ArrayVirtualNetworkRule = Array<VirtualNetworkRule>;
/**
 * Virtual Network Rule
 */
...
export type ArrayIpRules = Array<IPRules>;
/**
 * IP rule with specific IP or IP range in CIDR format.
 */
...
export type RecordStringUserAssignedIdentity = Record<string, UserAssignedIdentity>;
/**
...
export type ArrayRoleAssignmentDetail = Array<RoleAssignmentDetail>;
/**
...
export type ArrayDataProduct = Array<DataProduct>;
/**
