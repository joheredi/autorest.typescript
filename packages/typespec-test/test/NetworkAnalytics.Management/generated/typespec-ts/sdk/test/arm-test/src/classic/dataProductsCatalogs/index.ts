...
import { listBySubscription, listByResourceGroup, get } from "../../api/dataProductsCatalogs/operations.js";
import { DataProductsCatalogsListBySubscriptionOptionalParams, DataProductsCatalogsListByResourceGroupOptionalParams, DataProductsCatalogsGetOptionalParams } from "../../api/dataProductsCatalogs/options.js";
...
function _getDataProductsCatalogs(context: NetworkAnalyticsApiContext) {
    return {
            listBySubscription: (options?: DataProductsCatalogsListBySubscriptionOptionalParams) => listBySubscription(context,options),listByResourceGroup: (resourceGroupName: string,options?: DataProductsCatalogsListByResourceGroupOptionalParams) => listByResourceGroup(context,resourceGroupName,options),get: (resourceGroupName: string,options?: DataProductsCatalogsGetOptionalParams) => get(context,resourceGroupName,options)
          }
}

export function _getDataProductsCatalogsOperations(context: NetworkAnalyticsApiContext): DataProductsCatalogsOperations {
    return {
