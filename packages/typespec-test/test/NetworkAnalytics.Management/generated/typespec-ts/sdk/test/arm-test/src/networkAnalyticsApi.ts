import { createNetworkAnalyticsApi, NetworkAnalyticsApiContext, NetworkAnalyticsApiOptionalParams } from "./api/index.js";
import { DataProductsOperations, _getDataProductsOperations } from "./classic/dataProducts/index.js";
import { DataProductsCatalogsOperations, _getDataProductsCatalogsOperations } from "./classic/dataProductsCatalogs/index.js";
...
export class NetworkAnalyticsApi {
    ...
    constructor(credential: TokenCredential, subscriptionIdOrOptions?: string | NetworkAnalyticsApiOptionalParams, options?: NetworkAnalyticsApiOptionalParams) {
        ...
        this._client = createNetworkAnalyticsApi(credential,subscriptionId ?? "",{...options, userAgentOptions: { userAgentPrefix }});
