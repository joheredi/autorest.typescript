...
import { read, listBySubscription, listByResourceGroup, listRolesAssignments, removeUserRole, addUserRole, rotateKey, generateStorageAccountSasToken, $delete, update, get, create } from "../../api/dataProducts/operations.js";
import { DataProductsReadOptionalParams, DataProductsListBySubscriptionOptionalParams, DataProductsListByResourceGroupOptionalParams, DataProductsListRolesAssignmentsOptionalParams, DataProductsRemoveUserRoleOptionalParams, DataProductsAddUserRoleOptionalParams, DataProductsRotateKeyOptionalParams, DataProductsGenerateStorageAccountSasTokenOptionalParams, DataProductsDeleteOptionalParams, DataProductsUpdateOptionalParams, DataProductsGetOptionalParams, DataProductsCreateOptionalParams } from "../../api/dataProducts/options.js";
import { DataProduct, DataProductUpdate, AccountSas, AccountSasToken, KeyVaultInfo, RoleAssignmentCommonProperties, RoleAssignmentDetail, ListRoleAssignments, Client } from "../../models/models.js";
...
function _getDataProducts(context: NetworkAnalyticsApiContext) {
    return {
            read: (body: Client,options?: DataProductsReadOptionalParams) => read(context,body,options),listBySubscription: (options?: DataProductsListBySubscriptionOptionalParams) => listBySubscription(context,options),listByResourceGroup: (resourceGroupName: string,options?: DataProductsListByResourceGroupOptionalParams) => listByResourceGroup(context,resourceGroupName,options),listRolesAssignments: (resourceGroupName: string,dataProductName: string,body: Record<string, any>,options?: DataProductsListRolesAssignmentsOptionalParams) => listRolesAssignments(context,resourceGroupName,dataProductName,body,options),removeUserRole: (resourceGroupName: string,dataProductName: string,body: RoleAssignmentDetail,options?: DataProductsRemoveUserRoleOptionalParams) => removeUserRole(context,resourceGroupName,dataProductName,body,options),addUserRole: (resourceGroupName: string,dataProductName: string,body: RoleAssignmentCommonProperties,options?: DataProductsAddUserRoleOptionalParams) => addUserRole(context,resourceGroupName,dataProductName,body,options),rotateKey: (resourceGroupName: string,dataProductName: string,body: KeyVaultInfo,options?: DataProductsRotateKeyOptionalParams) => rotateKey(context,resourceGroupName,dataProductName,body,options),generateStorageAccountSasToken: (resourceGroupName: string,dataProductName: string,body: AccountSas,options?: DataProductsGenerateStorageAccountSasTokenOptionalParams) => generateStorageAccountSasToken(context,resourceGroupName,dataProductName,body,options),delete: (resourceGroupName: string,dataProductName: string,options?: DataProductsDeleteOptionalParams) => $delete(context,resourceGroupName,dataProductName,options),beginDelete: async (resourceGroupName: string,dataProductName: string,options?: DataProductsDeleteOptionalParams) => {
                      const poller = $delete(context,resourceGroupName,dataProductName,options);
                      await poller.submitted();
                      return getSimplePoller(poller);
                    },beginDeleteAndWait: async (resourceGroupName: string,dataProductName: string,options?: DataProductsDeleteOptionalParams) => {
                      return await $delete(context,resourceGroupName,dataProductName,options);
                    },update: (resourceGroupName: string,dataProductName: string,properties: DataProductUpdate,options?: DataProductsUpdateOptionalParams) => update(context,resourceGroupName,dataProductName,properties,options),beginUpdate: async (resourceGroupName: string,dataProductName: string,properties: DataProductUpdate,options?: DataProductsUpdateOptionalParams) => {
                      const poller = update(context,resourceGroupName,dataProductName,properties,options);
                      await poller.submitted();
                      return getSimplePoller(poller);
                    },beginUpdateAndWait: async (resourceGroupName: string,dataProductName: string,properties: DataProductUpdate,options?: DataProductsUpdateOptionalParams) => {
                      return await update(context,resourceGroupName,dataProductName,properties,options);
                    },get: (resourceGroupName: string,dataProductName: string,options?: DataProductsGetOptionalParams) => get(context,resourceGroupName,dataProductName,options),create: (resourceGroupName: string,dataProductName: string,resource: DataProduct,options?: DataProductsCreateOptionalParams) => create(context,resourceGroupName,dataProductName,resource,options),beginCreate: async (resourceGroupName: string,dataProductName: string,resource: DataProduct,options?: DataProductsCreateOptionalParams) => {
                      const poller = create(context,resourceGroupName,dataProductName,resource,options);
                      await poller.submitted();
                      return getSimplePoller(poller);
                    },beginCreateAndWait: async (resourceGroupName: string,dataProductName: string,resource: DataProduct,options?: DataProductsCreateOptionalParams) => {
                      return await create(context,resourceGroupName,dataProductName,resource,options);
                    }
          }
}

export function _getDataProductsOperations(context: NetworkAnalyticsApiContext): DataProductsOperations {
    return {
