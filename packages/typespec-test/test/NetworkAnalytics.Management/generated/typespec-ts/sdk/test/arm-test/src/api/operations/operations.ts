...
import { _OperationListResult, _operationListResultDeserializer, Operation, errorResponseDeserializer } from "../../models/models.js";
...
export function _listSend(context: Client, options: OperationsListOptionalParams = { requestOptions: {} }): StreamableMethod {
    const path = expandUrlTemplate("/providers/Microsoft.NetworkAnalytics/operations{?api%2Dversion}", {
...
export function list(context: Client, options: OperationsListOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<Operation> {
