...
export type RecordStringPassFailMetric = Record<string, PassFailMetric>;
/**
 * Pass fail metric
 */
...
export type RecordStringSecret = Record<string, Secret>;
/**
 * Secret
 */
...
export type ArrayRegionalConfiguration = Array<RegionalConfiguration>;
/**
 * Region distribution configuration for the load test.
 */
...
export type ArrayTestFileInfo = Array<TestFileInfo>;
/**
 * Test kind
 */
...
export type RecordStringAppComponent = Record<string, AppComponent>;
/**
...
export type RecordStringResourceMetric = Record<string, ResourceMetric>;
/**
...
export type ArrayTest = Array<Test>;
/**
 * Load test run model
 */
...
export type ArrayErrorDetails = Array<ErrorDetails>;
/**
 * Error details if there is any failure in load test run
 */
...
export type RecordStringTestRunStatistics = Record<string, TestRunStatistics>;
/**
 * Test run statistics.
 */
...
export type ArrayTestRunFileInfo = Array<TestRunFileInfo>;
/**
 * The output artifacts for the test run.
 */
...
export type ArrayMetricDefinition = Array<MetricDefinition>;
/**
 * Metric definition
 */
...
export type ArrayNameAndDesc = Array<NameAndDesc>;
/**
...
export type ArrayMetricAvailability = Array<MetricAvailability>;
/**
...
export type ArrayMetricNamespace = Array<MetricNamespace>;
/**
...
export type ArrayDimensionFilter = Array<DimensionFilter>;
/**
...
export type ArrayTimeSeriesElement = Array<TimeSeriesElement>;
/**
...
export type ArrayMetricValue = Array<MetricValue>;
/**
...
export type ArrayDimensionValue = Array<DimensionValue>;
/**
...
export type ArrayTestRun = Array<TestRun>;
/**
 ...
 */
export type TargetResourceConfigurationsUnion = FunctionFlexConsumptionTargetResourceConfigurations | TargetResourceConfigurationsUnion;
/**
 ...
 */
export interface FunctionFlexConsumptionTargetResourceConfigurations extends TargetResourceConfigurationsUnion {
  /**
...
export type RecordStringFunctionFlexConsumptionResourceConfiguration = Record<string, FunctionFlexConsumptionResourceConfiguration>;
/**
...
export type ArrayTestProfile = Array<TestProfile>;
/**
...
export type RecordStringTestRunDetail = Record<string, TestRunDetail>;
/**
...
export type ArrayTestProfileRunRecommendation = Array<TestProfileRunRecommendation>;
/**
...
export type ArrayTestProfileRun = Array<TestProfileRun>;
/**
