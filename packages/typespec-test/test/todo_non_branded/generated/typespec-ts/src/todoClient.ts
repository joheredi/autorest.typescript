...
import { TodoItemsOperations, _getTodoItemsOperations } from "./classic/todoItems/index.js";
...
export class TodoClient {
    ...
    constructor(endpointParam: string, credential: (KeyCredential), options: TodoClientOptionalParams = {}) {
        ...
        this._client = createTodo(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
