import { Client, ClientOptions, getClient, KeyCredential, isKeyCredential } from "@typespec/ts-http-runtime";
...
export function createTodo(endpointParam: string, credential: (KeyCredential), options: TodoClientOptionalParams = {}): TodoContext {
    ...
    const { apiVersion: _, ...updatedOptions } = {...options,userAgentOptions: { userAgentPrefix },};
