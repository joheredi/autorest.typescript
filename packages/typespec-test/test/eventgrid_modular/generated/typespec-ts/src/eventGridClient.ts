...
import { renewCloudEventLocks, rejectCloudEvents, releaseCloudEvents, acknowledgeCloudEvents, receiveCloudEvents, publishCloudEvents, publishCloudEvent } from "./api/operations.js";
...
import { CloudEvent, PublishResult, ReceiveResult, AcknowledgeResult, ReleaseResult, RejectResult, RenewCloudEventLocksResult } from "./models/models.js";
...
export class EventGridClient {
    ...
    constructor(endpointParam: string, credential: (KeyCredential | TokenCredential), options: EventGridClientOptionalParams = {}) {
        ...
        this._client = createEventGrid(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
    ...
    renewCloudEventLocks(topicName: string, eventSubscriptionName: string, lockTokens: (string)[], options: RenewCloudEventLocksOptionalParams = { requestOptions: {} }): Promise<RenewCloudEventLocksResult> {
    ...
    rejectCloudEvents(topicName: string, eventSubscriptionName: string, lockTokens: (string)[], options: RejectCloudEventsOptionalParams = { requestOptions: {} }): Promise<RejectResult> {
    ...
    releaseCloudEvents(topicName: string, eventSubscriptionName: string, lockTokens: (string)[], options: ReleaseCloudEventsOptionalParams = { requestOptions: {} }): Promise<ReleaseResult> {
    ...
    acknowledgeCloudEvents(topicName: string, eventSubscriptionName: string, lockTokens: (string)[], options: AcknowledgeCloudEventsOptionalParams = { requestOptions: {} }): Promise<AcknowledgeResult> {
    ...
    receiveCloudEvents(topicName: string, eventSubscriptionName: string, options: ReceiveCloudEventsOptionalParams = { requestOptions: {} }): Promise<ReceiveResult> {
    ...
    publishCloudEvents(topicName: string, events: (CloudEvent)[], options: PublishCloudEventsOptionalParams = { requestOptions: {} }): Promise<PublishResult> {
        return publishCloudEvents(this._client, topicName, events, options)
    }

    /** Publish a single Cloud Event to a namespace topic. */
    publishCloudEvent(topicName: string, event: CloudEvent, options: PublishCloudEventOptionalParams = { requestOptions: {} }): Promise<PublishResult> {
