import { createAnomalyDetector, AnomalyDetectorContext, AnomalyDetectorClientOptionalParams } from "./api/index.js";
import { MultivariateOperations, _getMultivariateOperations } from "./classic/multivariate/index.js";
...
export class AnomalyDetectorClient {
    ...
    constructor(endpointParam: string, credential: KeyCredential, options: AnomalyDetectorClientOptionalParams = {}) {
        ...
        this._client = createAnomalyDetector(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
