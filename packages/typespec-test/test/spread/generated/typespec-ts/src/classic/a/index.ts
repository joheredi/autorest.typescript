...
import { ATest4OptionalParams, ATest3OptionalParams, ATest2OptionalParams, ATest1OptionalParams } from "../../api/a/options.js";
...
function _getA(context: DemoServiceContext) {
    return {
            test4: (body: {
          "prop": string
        },options?: ATest4OptionalParams) => test4(context,body,options),test3: (body: {
          "prop": string
        },options?: ATest3OptionalParams) => test3(context,body,options),test2: (prop: string,options?: ATest2OptionalParams) => test2(context,prop,options),test1: (a: string,b: string,c: string,options?: ATest1OptionalParams) => test1(context,a,b,c,options)
          }
}
