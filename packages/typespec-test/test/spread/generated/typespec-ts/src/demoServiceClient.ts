import { createDemoService, DemoServiceContext, DemoServiceClientOptionalParams } from "./api/index.js";
...
export class DemoServiceClient {
    ...
    constructor(endpointParam: string, options: DemoServiceClientOptionalParams = {}) {
        ...
        this._client = createDemoService(endpointParam,{...options, userAgentOptions: { userAgentPrefix }});
