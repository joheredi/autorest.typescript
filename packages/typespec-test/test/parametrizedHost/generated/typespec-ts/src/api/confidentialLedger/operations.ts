...
export function _listCollectionsSend(context: Client, options: ConfidentialLedgerListCollectionsOptionalParams = { requestOptions: {} }): StreamableMethod {
    const path = expandUrlTemplate("/app/collections{?api%2Dversion}", {
...
export async function _listCollectionsDeserialize(result: PathUncheckedResponse): Promise<(Collection)[]> {
...
export async function listCollections(context: Client, options: ConfidentialLedgerListCollectionsOptionalParams = { requestOptions: {} }): Promise<(Collection)[]> {
