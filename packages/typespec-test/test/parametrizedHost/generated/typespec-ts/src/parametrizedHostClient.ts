import { createParametrizedHost, ParametrizedHostContext, ParametrizedHostClientOptionalParams } from "./api/index.js";
import { ConfidentialLedgerOperations, _getConfidentialLedgerOperations } from "./classic/confidentialLedger/index.js";
...
export class ParametrizedHostClient {
    ...
    constructor(credential: TokenCredential, options: ParametrizedHostClientOptionalParams = {}) {
        ...
        this._client = createParametrizedHost(credential,{...options, userAgentOptions: { userAgentPrefix }});
