import { createChatProtocol, ChatProtocolContext, ChatProtocolClientOptionalParams } from "./api/index.js";
...
import { StreamingChatCompletionOptionsRecord, ChatCompletionChunkRecord, ChatCompletionOptionsRecord, ChatCompletionRecord } from "./models/models.js";
...
export class ChatProtocolClient {
    ...
    constructor(endpointParam: string, credential: (KeyCredential | TokenCredential), options: ChatProtocolClientOptionalParams = {}) {
        ...
        this._client = createChatProtocol(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
        this.pipeline = this._client.pipeline;
    }

    /** Creates a new chat completion. */
    create(body: ChatCompletionOptionsRecord, options: CreateOptionalParams = { requestOptions: {} }): Promise<ChatCompletionRecord> {
        return create(this._client, body, options)
    }

    /** Creates a new streaming chat completion. */
    createStreaming(body: StreamingChatCompletionOptionsRecord, options: CreateStreamingOptionalParams = { requestOptions: {} }): Promise<ChatCompletionChunkRecord> {
