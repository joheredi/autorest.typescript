import { createSAPWidgetService, SAPWidgetServiceContext, SAPWidgetServiceClientOptionalParams } from "./api/index.js";
...
export class SAPWidgetServiceClient {
    ...
    constructor(endpointParam: string, credential: (KeyCredential), options: SAPWidgetServiceClientOptionalParams = {}) {
        ...
        this._client = createSAPWidgetService(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
