...
export function createSAPWidgetService(endpointParam: string, credential: (KeyCredential), options: SAPWidgetServiceClientOptionalParams = {}): SAPWidgetServiceContext {
