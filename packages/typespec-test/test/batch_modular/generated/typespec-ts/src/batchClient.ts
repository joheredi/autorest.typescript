...
export class BatchClient {
    ...
    constructor(endpointParam: string, credential: TokenCredential, options: BatchClientOptionalParams = {}) {
        ...
        this._client = createBatch(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
        this.pipeline = this._client.pipeline;
    }

    /** Lists all of the files in Task directories on the specified Compute Node. */
    listNodeFiles(poolId: string, nodeId: string, options: ListNodeFilesOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<NodeFile> {
        return listNodeFiles(this._client, poolId, nodeId, options)
    }

    /** Gets the properties of the specified Compute Node file. */
    getNodeFileProperties(poolId: string, nodeId: string, filePath: string, options: GetNodeFilePropertiesOptionalParams = { requestOptions: {} }): Promise<void> {
        return getNodeFileProperties(this._client, poolId, nodeId, filePath, options)
    }

    /** Returns the content of the specified Compute Node file. */
    getNodeFile(poolId: string, nodeId: string, filePath: string, options: GetNodeFileOptionalParams = { requestOptions: {} }): Promise<Uint8Array> {
        return getNodeFile(this._client, poolId, nodeId, filePath, options)
    }

    /** Deletes the specified file from the Compute Node. */
    deleteNodeFile(poolId: string, nodeId: string, filePath: string, options: DeleteNodeFileOptionalParams = { requestOptions: {} }): Promise<void> {
        return deleteNodeFile(this._client, poolId, nodeId, filePath, options)
    }

    /** Lists the Compute Nodes Extensions in the specified Pool. */
    listNodeExtensions(poolId: string, nodeId: string, options: ListNodeExtensionsOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<NodeVMExtension> {
        return listNodeExtensions(this._client, poolId, nodeId, options)
    }

    /** Gets information about the specified Compute Node Extension. */
    getNodeExtension(poolId: string, nodeId: string, extensionName: string, options: GetNodeExtensionOptionalParams = { requestOptions: {} }): Promise<NodeVMExtension> {
        return getNodeExtension(this._client, poolId, nodeId, extensionName, options)
    }

    /** Lists the Compute Nodes in the specified Pool. */
    listNodes(poolId: string, options: ListNodesOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchNode> {
     ...
     */
    uploadNodeLogs(poolId: string, nodeId: string, body: UploadBatchServiceLogsOptions, options: UploadNodeLogsOptionalParams = { requestOptions: {} }): Promise<UploadBatchServiceLogsResult> {
     ...
     */
    getNodeRemoteDesktopFile(poolId: string, nodeId: string, options: GetNodeRemoteDesktopFileOptionalParams = { requestOptions: {} }): Promise<Uint8Array> {
     ...
     * API.
     */
    getNodeRemoteLoginSettings(poolId: string, nodeId: string, options: GetNodeRemoteLoginSettingsOptionalParams = { requestOptions: {} }): Promise<BatchNodeRemoteLoginSettingsResult> {
     ...
     * state is disabled
     */
    enableNodeScheduling(poolId: string, nodeId: string, options: EnableNodeSchedulingOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    disableNodeScheduling(poolId: string, nodeId: string, options: DisableNodeSchedulingOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    reimageNode(poolId: string, nodeId: string, options: ReimageNodeOptionalParams = { requestOptions: {} }): Promise<void> {
        return reimageNode(this._client, poolId, nodeId, options)
    }

    /** You can restart a Compute Node only if it is in an idle or running state. */
    rebootNode(poolId: string, nodeId: string, options: RebootNodeOptionalParams = { requestOptions: {} }): Promise<void> {
        return rebootNode(this._client, poolId, nodeId, options)
    }

    /** Gets information about the specified Compute Node. */
    getNode(poolId: string, nodeId: string, options: GetNodeOptionalParams = { requestOptions: {} }): Promise<BatchNode> {
     ...
     */
    replaceNodeUser(poolId: string, nodeId: string, userName: string, body: BatchNodeUserUpdateOptions, options: ReplaceNodeUserOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     * running state.
     */
    deleteNodeUser(poolId: string, nodeId: string, userName: string, options: DeleteNodeUserOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     * running state.
     */
    createNodeUser(poolId: string, nodeId: string, body: BatchNodeUserCreateOptions, options: CreateNodeUserOptionalParams = { requestOptions: {} }): Promise<void> {
        return createNodeUser(this._client, poolId, nodeId, body, options)
    }

    /** Lists the files in a Task's directory on its Compute Node. */
    listTaskFiles(jobId: string, taskId: string, options: ListTaskFilesOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<NodeFile> {
        return listTaskFiles(this._client, jobId, taskId, options)
    }

    /** Gets the properties of the specified Task file. */
    getTaskFileProperties(jobId: string, taskId: string, filePath: string, options: GetTaskFilePropertiesOptionalParams = { requestOptions: {} }): Promise<void> {
        return getTaskFileProperties(this._client, jobId, taskId, filePath, options)
    }

    /** Returns the content of the specified Task file. */
    getTaskFile(jobId: string, taskId: string, filePath: string, options: GetTaskFileOptionalParams = { requestOptions: {} }): Promise<Uint8Array> {
        return getTaskFile(this._client, jobId, taskId, filePath, options)
    }

    /** Deletes the specified Task file from the Compute Node where the Task ran. */
    deleteTaskFile(jobId: string, taskId: string, filePath: string, options: DeleteTaskFileOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    reactivateTask(jobId: string, taskId: string, options: ReactivateTaskOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    terminateTask(jobId: string, taskId: string, options: TerminateTaskOptionalParams = { requestOptions: {} }): Promise<void> {
        return terminateTask(this._client, jobId, taskId, options)
    }

    /** If the Task is not a multi-instance Task then this returns an empty collection. */
    listSubTasks(jobId: string, taskId: string, options: ListSubTasksOptionalParams = { requestOptions: {} }): Promise<BatchTaskListSubtasksResult> {
        return listSubTasks(this._client, jobId, taskId, options)
    }

    /** Updates the properties of the specified Task. */
    replaceTask(jobId: string, taskId: string, body: BatchTask, options: ReplaceTaskOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    getTask(jobId: string, taskId: string, options: GetTaskOptionalParams = { requestOptions: {} }): Promise<BatchTask> {
     ...
     * background.
     */
    deleteTask(jobId: string, taskId: string, options: DeleteTaskOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    createTaskCollection(jobId: string, collection: BatchTaskCollection, options: CreateTaskCollectionOptionalParams = { requestOptions: {} }): Promise<TaskAddCollectionResult> {
     ...
     * information about subtasks.
     */
    listTasks(jobId: string, options: ListTasksOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchTask> {
     ...
     */
    createTask(jobId: string, body: BatchTaskCreateOptions, options: CreateTaskOptionalParams = { requestOptions: {} }): Promise<void> {
        return createTask(this._client, jobId, body, options)
    }

    /** Lists all of the Job Schedules in the specified Account. */
    listJobSchedules(options: ListJobSchedulesOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchJobSchedule> {
        return listJobSchedules(this._client, options)
    }

    /** Creates a Job Schedule to the specified Account. */
    createJobSchedule(body: BatchJobScheduleCreateOptions, options: CreateJobScheduleOptionalParams = { requestOptions: {} }): Promise<void> {
        return createJobSchedule(this._client, body, options)
    }

    /** Terminates a Job Schedule. */
    terminateJobSchedule(jobScheduleId: string, options: TerminateJobScheduleOptionalParams = { requestOptions: {} }): Promise<void> {
        return terminateJobSchedule(this._client, jobScheduleId, options)
    }

    /** Enables a Job Schedule. */
    enableJobSchedule(jobScheduleId: string, options: EnableJobScheduleOptionalParams = { requestOptions: {} }): Promise<void> {
        return enableJobSchedule(this._client, jobScheduleId, options)
    }

    /** No new Jobs will be created until the Job Schedule is enabled again. */
    disableJobSchedule(jobScheduleId: string, options: DisableJobScheduleOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    replaceJobSchedule(jobScheduleId: string, body: BatchJobSchedule, options: ReplaceJobScheduleOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     * running Jobs are unaffected.
     */
    updateJobSchedule(jobScheduleId: string, body: BatchJobScheduleUpdateOptions, options: UpdateJobScheduleOptionalParams = { requestOptions: {} }): Promise<void> {
        return updateJobSchedule(this._client, jobScheduleId, body, options)
    }

    /** Gets information about the specified Job Schedule. */
    getJobSchedule(jobScheduleId: string, options: GetJobScheduleOptionalParams = { requestOptions: {} }): Promise<BatchJobSchedule> {
     ...
     */
    deleteJobSchedule(jobScheduleId: string, options: DeleteJobScheduleOptionalParams = { requestOptions: {} }): Promise<void> {
        return deleteJobSchedule(this._client, jobScheduleId, options)
    }

    /** Checks the specified Job Schedule exists. */
    jobScheduleExists(jobScheduleId: string, options: JobScheduleExistsOptionalParams = { requestOptions: {} }): Promise<void> {
        return jobScheduleExists(this._client, jobScheduleId, options)
    }

    /** Gets information about the specified Certificate. */
    getCertificate(thumbprintAlgorithm: string, thumbprint: string, options: GetCertificateOptionalParams = { requestOptions: {} }): Promise<BatchCertificate> {
     ...
     */
    deleteCertificate(thumbprintAlgorithm: string, thumbprint: string, options: DeleteCertificateOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    cancelCertificateDeletion(thumbprintAlgorithm: string, thumbprint: string, options: CancelCertificateDeletionOptionalParams = { requestOptions: {} }): Promise<void> {
        return cancelCertificateDeletion(this._client, thumbprintAlgorithm, thumbprint, options)
    }

    /** Lists all of the Certificates that have been added to the specified Account. */
    listCertificates(options: ListCertificatesOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchCertificate> {
        return listCertificates(this._client, options)
    }

    /** Creates a Certificate to the specified Account. */
    createCertificate(body: BatchCertificate, options: CreateCertificateOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    getJobTaskCounts(jobId: string, options: GetJobTaskCountsOptionalParams = { requestOptions: {} }): Promise<TaskCountsResult> {
     ...
     */
    listJobPreparationAndReleaseTaskStatus(jobId: string, options: ListJobPreparationAndReleaseTaskStatusOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<JobPreparationAndReleaseTaskExecutionInformation> {
        return listJobPreparationAndReleaseTaskStatus(this._client, jobId, options)
    }

    /** Lists the Jobs that have been created under the specified Job Schedule. */
    listJobsFromSchedule(jobScheduleId: string, options: ListJobsFromScheduleOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchJob> {
        return listJobsFromSchedule(this._client, jobScheduleId, options)
    }

    /** Lists all of the Jobs in the specified Account. */
    listJobs(options: ListJobsOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchJob> {
     ...
     * engineers.
     */
    createJob(body: BatchJobCreateOptions, options: CreateJobOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    terminateJob(jobId: string, options: TerminateJobOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    enableJob(jobId: string, options: EnableJobOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    disableJob(jobId: string, body: BatchJobDisableOptions, options: DisableJobOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    replaceJob(jobId: string, body: BatchJob, options: ReplaceJobOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    updateJob(jobId: string, body: BatchJobUpdateOptions, options: UpdateJobOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    deleteJob(jobId: string, options: DeleteJobOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     * use a list query.
     */
    listPoolNodeCounts(options: ListPoolNodeCountsOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<PoolNodeCounts> {
        return listPoolNodeCounts(this._client, options)
    }

    /** Lists all Virtual Machine Images supported by the Azure Batch service. */
    listSupportedImages(options: ListSupportedImagesOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<ImageInformation> {
     ...
     */
    removeNodes(poolId: string, body: NodeRemoveOptions, options: RemoveNodesOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    replacePoolProperties(poolId: string, body: BatchPoolReplaceOptions, options: ReplacePoolPropertiesOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    stopPoolResize(poolId: string, options: StopPoolResizeOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    resizePool(poolId: string, body: BatchPoolResizeOptions, options: ResizePoolOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    evaluatePoolAutoScale(poolId: string, body: BatchPoolEvaluateAutoScaleOptions, options: EvaluatePoolAutoScaleOptionalParams = { requestOptions: {} }): Promise<AutoScaleRun> {
     ...
     */
    enablePoolAutoScale(poolId: string, body: BatchPoolEnableAutoScaleOptions, options: EnablePoolAutoScaleOptionalParams = { requestOptions: {} }): Promise<void> {
        return enablePoolAutoScale(this._client, poolId, body, options)
    }

    /** Disables automatic scaling for a Pool. */
    disablePoolAutoScale(poolId: string, options: DisablePoolAutoScaleOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    updatePool(poolId: string, body: BatchPoolUpdateOptions, options: UpdatePoolOptionalParams = { requestOptions: {} }): Promise<void> {
        return updatePool(this._client, poolId, body, options)
    }

    /** Gets information about the specified Pool. */
    getPool(poolId: string, options: GetPoolOptionalParams = { requestOptions: {} }): Promise<BatchPool> {
        return getPool(this._client, poolId, options)
    }

    /** Gets basic properties of a Pool. */
    poolExists(poolId: string, options: PoolExistsOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    deletePool(poolId: string, options: DeletePoolOptionalParams = { requestOptions: {} }): Promise<void> {
        return deletePool(this._client, poolId, options)
    }

    /** Lists all of the Pools in the specified Account. */
    listPools(options: ListPoolsOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchPool> {
     ...
     */
    createPool(body: BatchPoolCreateOptions, options: CreatePoolOptionalParams = { requestOptions: {} }): Promise<void> {
     ...
     */
    listPoolUsageMetrics(options: ListPoolUsageMetricsOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<PoolUsageMetrics> {
     ...
     * API.
     */
    getApplication(applicationId: string, options: GetApplicationOptionalParams = { requestOptions: {} }): Promise<BatchApplication> {
     ...
     * API.
     */
    listApplications(options: ListApplicationsOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<BatchApplication> {
