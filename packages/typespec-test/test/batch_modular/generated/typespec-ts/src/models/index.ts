...
export {
  ...
  BatchApplication,
  Versions,
  deserializeBatchError,
  deserializeErrorMessage,
  deserializeBatchErrorDetail,
  deserializeBatchNode,
  deserializeTaskInformation,
  deserializeTaskExecutionInformation,
  deserializeTaskContainerExecutionInformation,
  deserializeTaskFailureInformation,
  deserializeNameValuePair,
  deserializeStartTask,
  deserializeTaskContainerSettings,
  deserializeContainerRegistry,
  deserializeBatchNodeIdentityReference,
  deserializeResourceFile,
  deserializeEnvironmentSetting,
  deserializeUserIdentity,
  deserializeAutoUserSpecification,
  deserializeStartTaskInformation,
  deserializeCertificateReference,
  deserializeBatchNodeError,
  deserializeBatchNodeEndpointConfiguration,
  deserializeInboundEndpoint,
  deserializeNodeAgentInformation,
  deserializeVirtualMachineInfo,
  deserializeImageReference,
  deserializeNodeVMExtension,
  deserializeVMExtension,
  deserializeVMExtensionInstanceView,
  deserializeInstanceViewStatus,
  deserializeNodeFile,
  deserializeFileProperties,
  deserializeExitConditions,
  deserializeExitCodeMapping,
  deserializeExitOptions,
  deserializeExitCodeRangeMapping,
  deserializeOutputFile,
  deserializeOutputFileDestination,
  deserializeOutputFileBlobContainerDestination,
  deserializeHttpHeader,
  deserializeOutputFileUploadOptions,
  deserializeAffinityInformation,
  deserializeTaskConstraints,
  deserializeMultiInstanceSettings,
  deserializeTaskDependencies,
  deserializeTaskIdRange,
  deserializeApplicationPackageReference,
  deserializeAuthenticationTokenSettings,
  deserializeBatchTask,
  deserializeBatchNodeInformation,
  deserializeTaskStatistics,
  deserializeTaskAddResult,
  deserializeSubtaskInformation,
  deserializeBatchJobSchedule,
  deserializeSchedule,
  deserializeJobSpecification,
  deserializeJobNetworkConfiguration,
  deserializeJobConstraints,
  deserializeJobManagerTask,
  deserializeJobPreparationTask,
  deserializeJobReleaseTask,
  deserializePoolInformation,
  deserializeAutoPoolSpecification,
  deserializePoolSpecification,
  deserializeCloudServiceConfiguration,
  deserializeVirtualMachineConfiguration,
  deserializeWindowsConfiguration,
  deserializeDataDisk,
  deserializeContainerConfiguration,
  deserializeDiskEncryptionConfiguration,
  deserializeNodePlacementConfiguration,
  deserializeOSDisk,
  deserializeDiffDiskSettings,
  deserializeTaskSchedulingPolicy,
  deserializeNetworkConfiguration,
  deserializePoolEndpointConfiguration,
  deserializeInboundNATPool,
  deserializeNetworkSecurityGroupRule,
  deserializePublicIpAddressConfiguration,
  deserializeUserAccount,
  deserializeLinuxUserConfiguration,
  deserializeWindowsUserConfiguration,
  deserializeMetadataItem,
  deserializeMountConfiguration,
  deserializeAzureBlobFileSystemConfiguration,
  deserializeNfsMountConfiguration,
  deserializeCifsMountConfiguration,
  deserializeAzureFileShareConfiguration,
  deserializeJobScheduleExecutionInformation,
  deserializeRecentJob,
  deserializeJobScheduleStatistics,
  deserializeBatchCertificate,
  deserializeDeleteCertificateError,
  deserializeBatchJob,
  deserializeJobExecutionInformation,
  deserializeJobSchedulingError,
  deserializeJobStatistics,
  deserializeJobPreparationAndReleaseTaskExecutionInformation,
  deserializeJobPreparationTaskExecutionInformation,
  deserializeJobReleaseTaskExecutionInformation,
  deserializeTaskCounts,
  deserializeTaskSlotCounts,
  deserializeImageInformation,
  deserializePoolNodeCounts,
  deserializeNodeCounts,
  deserializePoolUsageMetrics,
  deserializeBatchPool,
  deserializeResizeError,
  deserializeAutoScaleRun,
  deserializeAutoScaleRunError,
  deserializePoolStatistics,
  deserializeUsageStatistics,
  deserializeResourceStatistics,
  deserializeBatchPoolIdentity,
