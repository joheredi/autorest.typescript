...
import { ImagesCreateVariationOptionalParams, ImagesCreateEditOptionalParams } from "../../api/images/options.js";
import { CreateImageEditRequest, ImagesResponse, CreateImageVariationRequest } from "../../models/models.js";
...
function _getImages(context: OpenAIContext) {
    return {
            createVariation: (image: CreateImageVariationRequest,options?: ImagesCreateVariationOptionalParams) => createVariation(context,image,options),createEdit: (image: CreateImageEditRequest,options?: ImagesCreateEditOptionalParams) => createEdit(context,image,options)
          }
}
