...
function _getAudioTranslations(context: OpenAIContext) {
    return {
            create: (audio: CreateTranslationRequest,options?: AudioTranslationsCreateOptionalParams) => create(context,audio,options)
          }
}

export function _getAudioTranslationsOperations(context: OpenAIContext): AudioTranslationsOperations {
    return {
