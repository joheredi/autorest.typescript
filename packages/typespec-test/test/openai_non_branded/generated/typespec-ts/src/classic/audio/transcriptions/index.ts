...
function _getAudioTranscriptions(context: OpenAIContext) {
    return {
            create: (audio: CreateTranscriptionRequest,options?: AudioTranscriptionsCreateOptionalParams) => create(context,audio,options)
          }
}

export function _getAudioTranscriptionsOperations(context: OpenAIContext): AudioTranscriptionsOperations {
    return {
