...
import { ActionGroupsListOptionalParams, ActionGroupsGetOptionalParams } from "../../api/actionGroups/options.js";
...
function _getActionGroups(context: ComputeContext) {
    return {
            list: (options?: ActionGroupsListOptionalParams) => list(context,options),get: (resourceGroupName: string,actionGroupName: string,options?: ActionGroupsGetOptionalParams) => get(context,resourceGroupName,actionGroupName,options)
          }
}
