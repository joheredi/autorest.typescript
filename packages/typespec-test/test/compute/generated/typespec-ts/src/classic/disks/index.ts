...
import { DisksCreateOrUpdateOptionalParams, DisksGetOptionalParams } from "../../api/disks/options.js";
...
function _getDisks(context: ComputeContext) {
    return {
            createOrUpdate: (resourceGroupName: string,diskName: string,resource: ComputeDiskDisk,options?: DisksCreateOrUpdateOptionalParams) => createOrUpdate(context,resourceGroupName,diskName,resource,options),get: (resourceGroupName: string,diskName: string,options?: DisksGetOptionalParams) => get(context,resourceGroupName,diskName,options)
          }
}
