...
import { RestorePointCollectionsCreateOrUpdateOptionalParams, RestorePointCollectionsGetOptionalParams } from "../../api/restorePointCollections/options.js";
...
function _getRestorePointCollections(context: ComputeContext) {
    return {
            createOrUpdate: (resourceGroupName: string,restorePointCollectionName: string,resource: ComputeRestorePointCollection,options?: RestorePointCollectionsCreateOrUpdateOptionalParams) => createOrUpdate(context,resourceGroupName,restorePointCollectionName,resource,options),get: (resourceGroupName: string,restorePointCollectionName: string,options?: RestorePointCollectionsGetOptionalParams) => get(context,resourceGroupName,restorePointCollectionName,options)
          }
}

export function _getRestorePointCollectionsOperations(context: ComputeContext): RestorePointCollectionsOperations {
    return {
