...
import { VirtualMachinesCreateOrUpdateOptionalParams, VirtualMachinesGetOptionalParams } from "../../api/virtualMachines/options.js";
...
function _getVirtualMachines(context: ComputeContext) {
    return {
            createOrUpdate: (resourceGroupName: string,vmName: string,resource: ComputeVirtualMachine,options?: VirtualMachinesCreateOrUpdateOptionalParams) => createOrUpdate(context,resourceGroupName,vmName,resource,options),get: (resourceGroupName: string,vmName: string,options?: VirtualMachinesGetOptionalParams) => get(context,resourceGroupName,vmName,options)
          }
}
