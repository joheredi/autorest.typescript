...
import { DiskAccessesCreateOrUpdateOptionalParams, DiskAccessesGetOptionalParams } from "../../api/diskAccesses/options.js";
...
function _getDiskAccesses(context: ComputeContext) {
    return {
            createOrUpdate: (resourceGroupName: string,diskAccessName: string,resource: ComputeDiskDiskAccess,options?: DiskAccessesCreateOrUpdateOptionalParams) => createOrUpdate(context,resourceGroupName,diskAccessName,resource,options),get: (resourceGroupName: string,diskAccessName: string,options?: DiskAccessesGetOptionalParams) => get(context,resourceGroupName,diskAccessName,options)
          }
}
