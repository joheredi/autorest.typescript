...
import { ActionGroupsOperations, _getActionGroupsOperations } from "./classic/actionGroups/index.js";
import { DiskAccessesOperations, _getDiskAccessesOperations } from "./classic/diskAccesses/index.js";
import { DisksOperations, _getDisksOperations } from "./classic/disks/index.js";
import { RestorePointCollectionsOperations, _getRestorePointCollectionsOperations } from "./classic/restorePointCollections/index.js";
import { VirtualMachinesOperations, _getVirtualMachinesOperations } from "./classic/virtualMachines/index.js";
...
export class ComputeClient {
    ...
    constructor(credential: TokenCredential, subscriptionId: string, options: ComputeClientOptionalParams = {}) {
        ...
        this._client = createCompute(credential,subscriptionId,{...options, userAgentOptions: { userAgentPrefix }});
