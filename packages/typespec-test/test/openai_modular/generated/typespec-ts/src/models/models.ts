...
export type ArrayAudioTranscriptionTimestampGranularity = Array<AudioTranscriptionTimestampGranularity>;
/**
...
export type ArrayAudioTranscriptionSegment = Array<AudioTranscriptionSegment>;
/**
...
export type ArrayAudioTranscriptionWord = Array<AudioTranscriptionWord>;
/**
...
export type ArrayAudioTranslationSegment = Array<AudioTranslationSegment>;
/**
...
export type RecordStringNumber = Record<string, number>;
/**
...
export type ArrayContentFilterResultsForPrompt = Array<ContentFilterResultsForPrompt>;
/**
...
export interface ContentFilterResultDetailsForPrompt {
   ...
   */
  error?: <Unresolved Symbol: refkey[o203]>;
  /**
...
export type ArrayContentFilterBlocklistIdResult = Array<ContentFilterBlocklistIdResult>;
/**
...
export type ArrayChoice = Array<Choice>;
/**
...
export type ArrayCompletionsLogProbabilityModelTokenLogprob = Array<_CompletionsLogProbabilityModelTokenLogprob>;
export type ArrayRecordStringCompletionsLogProbabilityModelTokenLogprob = Array<Record<string, _CompletionsLogProbabilityModelTokenLogprob>>;
export type RecordStringCompletionsLogProbabilityModelTokenLogprob = Record<string, _CompletionsLogProbabilityModelTokenLogprob>;
/**
...
export type ArrayChatRequestMessageUnion = Array<ChatRequestMessageUnion>;
/**
 ...
 */
export type ChatRequestMessageUnion = ChatRequestSystemMessage | ChatRequestUserMessage | ChatRequestAssistantMessage | ChatRequestToolMessage | ChatRequestFunctionMessage | ChatRequestMessageUnion;
/**
 ...
 * response.
 */
export interface ChatRequestSystemMessage extends ChatRequestMessageUnion {
  /**
 ...
 */
export interface ChatRequestUserMessage extends ChatRequestMessageUnion {
  /**
...
export type ArrayChatMessageContentItemUnion = Array<ChatMessageContentItemUnion>;
/**
 ...
 */
export type ChatMessageContentItemUnion = ChatMessageTextContentItem | ChatMessageImageContentItem | ChatMessageContentItemUnion;
/**
 * A structured chat content item containing plain text.
 */
export interface ChatMessageTextContentItem extends ChatMessageContentItemUnion {
  /**
 ...
 */
export interface ChatMessageImageContentItem extends ChatMessageContentItemUnion {
  /**
 ...
 */
export interface ChatRequestAssistantMessage extends ChatRequestMessageUnion {
  /**
...
export type ArrayChatCompletionsToolCallUnion = Array<ChatCompletionsToolCallUnion>;
/**
 ...
 */
export type ChatCompletionsToolCallUnion = ChatCompletionsFunctionToolCall | ChatCompletionsToolCallUnion;
/**
 * A tool call to a function tool, issued by the model in evaluation of a configured function tool, that represents
 * a function invocation needed for a subsequent chat completions request to resolve.
 */
export interface ChatCompletionsFunctionToolCall extends ChatCompletionsToolCallUnion {
  /**
 ...
 */
export interface ChatRequestToolMessage extends ChatRequestMessageUnion {
  /**
 ...
 */
export interface ChatRequestFunctionMessage extends ChatRequestMessageUnion {
  /**
...
export type ArrayFunctionDefinition = Array<FunctionDefinition>;
/**
...
export type ArrayAzureChatExtensionConfigurationUnion = Array<AzureChatExtensionConfigurationUnion>;
/**
 ...
 */
export type AzureChatExtensionConfigurationUnion = AzureSearchChatExtensionConfiguration | AzureMachineLearningIndexChatExtensionConfiguration | AzureCosmosDbChatExtensionConfiguration | ElasticsearchChatExtensionConfiguration | PineconeChatExtensionConfiguration | AzureChatExtensionConfigurationUnion;
/**
 *   A representation of configuration data for a single Azure OpenAI chat extension. This will be used by a chat
 *   completions request that should use Azure OpenAI chat extensions to augment the response behavior.
 *   The use of this configuration is compatible only with Azure OpenAI.
 ...
 * extension.
 */
export interface AzureSearchChatExtensionConfiguration extends AzureChatExtensionConfigurationUnion {
  /**
 ...
 */
export interface OnYourDataApiKeyAuthenticationOptions extends OnYourDataAuthenticationOptionsUnion {
  /**
 ...
 */
export interface OnYourDataConnectionStringAuthenticationOptions extends OnYourDataAuthenticationOptionsUnion {
  /**
 ...
 */
export interface OnYourDataKeyAndKeyIdAuthenticationOptions extends OnYourDataAuthenticationOptionsUnion {
  /**
 ...
 */
export interface OnYourDataEncodedApiKeyAuthenticationOptions extends OnYourDataAuthenticationOptionsUnion {
  /**
 ...
 */
export interface OnYourDataAccessTokenAuthenticationOptions extends OnYourDataAuthenticationOptionsUnion {
  /**
 ...
 */
export interface OnYourDataSystemAssignedManagedIdentityAuthenticationOptions extends OnYourDataAuthenticationOptionsUnion {
  /**
 ...
 */
export interface OnYourDataUserAssignedManagedIdentityAuthenticationOptions extends OnYourDataAuthenticationOptionsUnion {
  /**
...
export type ArrayOnYourDataContextProperty = Array<OnYourDataContextProperty>;
/**
 ...
 */
export type OnYourDataVectorizationSourceUnion = OnYourDataEndpointVectorizationSource | OnYourDataDeploymentNameVectorizationSource | OnYourDataModelIdVectorizationSource | OnYourDataVectorizationSourceUnion;
/**
 ...
 */
export interface OnYourDataEndpointVectorizationSource extends OnYourDataVectorizationSourceUnion {
  /**
 ...
 */
export type OnYourDataVectorSearchAuthenticationOptionsUnion = OnYourDataVectorSearchApiKeyAuthenticationOptions | OnYourDataVectorSearchAccessTokenAuthenticationOptions | OnYourDataVectorSearchAuthenticationOptionsUnion;
/**
 ...
 * The authentication options for Azure OpenAI On Your Data when using an API key.
 */
export interface OnYourDataVectorSearchApiKeyAuthenticationOptions extends OnYourDataVectorSearchAuthenticationOptionsUnion {
  /**
   * The authentication type of API key.
   */
  type: "api_key";
 ...
 */
export interface OnYourDataVectorSearchAccessTokenAuthenticationOptions extends OnYourDataVectorSearchAuthenticationOptionsUnion {
  /**
   * The authentication type of access token.
   */
  type: "access_token";
 ...
 */
export interface OnYourDataDeploymentNameVectorizationSource extends OnYourDataVectorizationSourceUnion {
  /**
 ...
 */
export interface OnYourDataModelIdVectorizationSource extends OnYourDataVectorizationSourceUnion {
  /**
 ...
 */
export interface AzureMachineLearningIndexChatExtensionConfiguration extends AzureChatExtensionConfigurationUnion {
  /**
   * The type label to use when configuring Azure OpenAI chat extensions. This should typically not be changed from its
 ...
 * extension.
 */
export interface AzureCosmosDbChatExtensionConfiguration extends AzureChatExtensionConfigurationUnion {
  /**
   * The type label to use when configuring Azure OpenAI chat extensions. This should typically not be changed from its
 ...
 * extension.
 */
export interface ElasticsearchChatExtensionConfiguration extends AzureChatExtensionConfigurationUnion {
  /**
   * The type label to use when configuring Azure OpenAI chat extensions. This should typically not be changed from its
 ...
 * extension.
 */
export interface PineconeChatExtensionConfiguration extends AzureChatExtensionConfigurationUnion {
  /**
   * The type label to use when configuring Azure OpenAI chat extensions. This should typically not be changed from its
 ...
 */
export type ChatCompletionsResponseFormatUnion = ChatCompletionsTextResponseFormat | ChatCompletionsJsonResponseFormat | ChatCompletionsResponseFormatUnion;
/**
 ...
 */
export interface ChatCompletionsTextResponseFormat extends ChatCompletionsResponseFormatUnion {
  /**
 ...
 */
export interface ChatCompletionsJsonResponseFormat extends ChatCompletionsResponseFormatUnion {
  /**
   * The discriminated object type, which is always 'json_object' for this format.
   */
  type: "json_object";
}
export type ArrayChatCompletionsToolDefinitionUnion = Array<ChatCompletionsToolDefinitionUnion>;
/**
 ...
 */
export type ChatCompletionsToolDefinitionUnion = ChatCompletionsFunctionToolDefinition | ChatCompletionsToolDefinitionUnion;
/**
 * The definition information for a chat completions function tool that can call a function in response to a tool call.
 */
export interface ChatCompletionsFunctionToolDefinition extends ChatCompletionsToolDefinitionUnion {
  /**
 ...
 */
export type _ChatCompletionsOptionsToolChoice = ChatCompletionsToolSelectionPreset | ChatCompletionsNamedToolSelectionUnion;
/**
 ...
 */
export type ChatCompletionsNamedToolSelectionUnion = ChatCompletionsNamedFunctionToolSelection | ChatCompletionsNamedToolSelectionUnion;
/**
 * A tool selection of a specific, named function tool that will limit chat completions to using the named function.
 */
export interface ChatCompletionsNamedFunctionToolSelection extends ChatCompletionsNamedToolSelectionUnion {
  /**
   ...
   */
  function_: ChatCompletionsFunctionToolSelection;
}
/**
 * A tool selection of a specific, named function tool that will limit chat completions to using the named function.
 */
...
export type ArrayChatChoice = Array<ChatChoice>;
/**
...
export type ArrayAzureChatExtensionDataSourceResponseCitation = Array<AzureChatExtensionDataSourceResponseCitation>;
/**
...
export type ArrayAzureChatExtensionRetrievedDocument = Array<AzureChatExtensionRetrievedDocument>;
/**
...
export type ArrayChatTokenLogProbabilityResult = Array<ChatTokenLogProbabilityResult>;
/**
...
export type ArrayChatTokenLogProbabilityInfo = Array<ChatTokenLogProbabilityInfo>;
/**
 ...
 */
export type ChatFinishDetailsUnion = StopFinishDetails | MaxTokensFinishDetails | ChatFinishDetailsUnion;
/**
 * A structured representation of a stop reason that signifies natural termination by the model.
 */
export interface StopFinishDetails extends ChatFinishDetailsUnion {
  /**
 ...
 * complete.
 */
export interface MaxTokensFinishDetails extends ChatFinishDetailsUnion {
  /**
...
export type ArrayAzureGroundingEnhancementLine = Array<AzureGroundingEnhancementLine>;
/**
...
export type ArrayAzureGroundingEnhancementLineSpan = Array<AzureGroundingEnhancementLineSpan>;
/**
...
export type ArrayAzureGroundingEnhancementCoordinatePoint = Array<AzureGroundingEnhancementCoordinatePoint>;
/**
...
export type ArrayImageGenerationData = Array<ImageGenerationData>;
/**
...
export type ArrayEmbeddingItem = Array<EmbeddingItem>;
/**
