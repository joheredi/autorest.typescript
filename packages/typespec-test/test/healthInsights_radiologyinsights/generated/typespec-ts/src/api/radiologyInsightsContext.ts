...
export function createRadiologyInsights(endpointParam: string, credential: KeyCredential, options: RadiologyInsightsClientOptionalParams = {}): RadiologyInsightsContext {
