import { createRadiologyInsights, RadiologyInsightsContext, RadiologyInsightsClientOptionalParams } from "./api/index.js";
...
export class RadiologyInsightsClient {
    ...
    constructor(endpointParam: string, credential: KeyCredential, options: RadiologyInsightsClientOptionalParams = {}) {
        ...
        this._client = createRadiologyInsights(endpointParam,credential,{...options, userAgentOptions: { userAgentPrefix }});
        this.pipeline = this._client.pipeline;
    }

    /** Creates a Radiology Insights job with the given request body. */
    inferRadiologyInsights(patients: (PatientRecord)[], options: InferRadiologyInsightsOptionalParams = { requestOptions: {} }): PollerLike<OperationState<RadiologyInsightsInferenceResult>, RadiologyInsightsInferenceResult> {
